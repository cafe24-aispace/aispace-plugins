...
- **Field-tested FAQ built in**: answers distilled from real customer support cases (SSL renewal issues, GitHub auto-redeploy, DB access, deletion paths) plus deploy-failure triage rules — updated as new patterns emerge.

## How the built-in knowledge works
